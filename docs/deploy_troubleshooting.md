...
1. You see `CERTIFICATE_VERIFY_FAILED` when the `prepdocs.py` script runs. That's typically due to incorrect SSL certificates setup on your machine. Configure your OS or Python certificate store so Python can validate HTTPS certificates.
